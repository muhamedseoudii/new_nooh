class ChannelCategoryModel {
  String? status;
  List<ChannelCategoryData>? data;

  ChannelCategoryModel({this.status, this.data});
  ...
  ChannelCategoryModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        data!.add(new ChannelCategoryData.fromJson(v));
      });
    }
  }
...
class ChannelCategoryData {
  ...
  ChannelCategoryData.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
    title = json['title'];
