class AllChannel {
  ...
  AllChannel({this.status, this.data});

  AllChannel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    if (json['data'] != null) {
      data = <AllChannelData>[];
      json['data'].forEach((v) {
        data!.add(new AllChannelData.fromJson(v));
      });
    }
  }
...
class AllChannelData {
  ...
  AllChannelData.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
    title = json['title'];
